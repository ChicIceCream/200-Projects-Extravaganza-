...
# Streamlit code to display the virtual makeup in real-time
st.title("Real-time Virtual Makeup Application")

enable = st.checkbox("Enable camera for real-time filter")
...
if enable:
    ...
    while enable:
        ...
        # Process the frame with MakeupApplication
    ...
    # Release the camera once the loop ends
    camera.release()